    ...
    def __call__(self, model):
        ...
        with torch.no_grad():
            for eval_data in tqdm(self.eval_list, desc="Evaluating"):
                ...
                source, _ = librosa.load(source_path, sr=self.sampling_rate, mono=True, duration=10, offset=10)
                mixture, _ = librosa.load(mixture_path, sr=self.sampling_rate, mono=True, duration=10, offset=10)
